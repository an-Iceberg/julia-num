...
function ∂(f::Function, x⃗::Vector, i::Int, h::Real=1e-3)
...
function ∂2(f::Function, x⃗::Vector, i::Int, h::Real=1e-3)
  return ∂(x -> ∂(f, x, i, h), x⃗, i, h)
end

function ∂3(f::Function, x⃗::Vector, i::Int, h::Real=1e-3)
  return ∂(x -> ∂2(f, x, i, h), x⃗, i, h)
end

function ∂4(f::Function, x⃗::Vector, i::Int, h::Real=1e-3)
  return ∂(x -> ∂3(f, x, i, h), x⃗, i, h)
end
